...
# 헤론의 공식 사용
# 삼각형 넓이 A = sqrt(s*(s-a)*(s-b)*(s-c)), 이때 s = (a+b+c)/2
...
def triangle_area(a, b, c):
    ...
    return round(A, 3)  # 삼각형의 넓이, round함수_소수 셋째 자리에서 반올림


print(triangle_area(12, 12, 8))
...
# 삼각형 넓이 A = rs   (r = 내접원 반지름 길이, s = (a+b+c)/2 )
# r = A/s
...
def circle_radius(a, b, c):
    ...
    A = math.sqrt(s*(s-a)*(s-b)*(s-c))
    r = A/s
    return round(r, 3) # 내접원의 반지름 길이,  과제1의 A와 s를 사용


print("The radius of the round table is:",circle_radius(12, 12, 8))
