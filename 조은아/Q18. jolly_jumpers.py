...
def IsJollyJumper(sequence_list):
...
#        print("sequence:", seq)
        ...
        if seq[0] == 0 :
            ...
            for i in range(seq[0]-1):
                results.append(abs(seq[i+1] - seq[i+2]))
            results.sort()
#            print(results)
        
            flag = 2
            for r in range(1, seq[0]):
                if not(r==results[r-1]):
                    flag = 3
                    break
...
# sol 1
IsJollyJumper(["4 1 4 2 3", "5 1 3 2 -1 6"])

# sol 2
IsJollyJumper(["4 1 4 2 3", "5 1 3 2 -1 6", "0"])
